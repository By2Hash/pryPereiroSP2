namespace pryPereiroSP2
{
    public partial class frmReserva : Form
    {
        ...
        private void lblTipoCabaña_Click(object sender, EventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            chkCocina.Checked = false;
            chkHeladera.Checked = false;
            chkTelevisor.Checked = false; // en los radiobuttons se asigna sólo el que debe quedar en true        
            optEfectivo.Checked = true;
            txtNombre.Text = "";
            mtbTelefono.Text = "";
